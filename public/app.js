...
function refetchPageIfNeeded(page){
  if(!document.getElementById('workspace-select-panel').hidden)return; // no active workspace yet: every page API would answer 403 NO_WORKSPACE_ACCESS
